        ...
        <div class="form-group">
          <div class="input-group">
            <div class="input-group-prepend">
              <a href="<?= base_url("user-role/view/create") ?>" title="Crear unidad" class="btn btn-sm btn-default">
...
<script defer type="module" src="<?= base_url("public/js/user_role/user_roles_list.js") ?>"></script>